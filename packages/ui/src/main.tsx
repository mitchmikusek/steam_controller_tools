  ...
  <StrictMode>
    ...
    <div className="disclaimer">
      <div className="footer-icons">
        ...
        <a href="https://ko-fi.com/mitchmikusek" target="_blank" rel="noopener noreferrer" aria-label="Ko-fi" title="Ko-fi">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
        ...
        <a
          href="https://store.steampowered.com/app/353370/Steam_Controller_2015/"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Steam Controller on Steam"
          title="Steam Controller on Steam"
        >
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
